...
import { filterByNumericValues } from '../../services/RequestPlanets';

export class FilterByValues extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      number: '',
  ...
  getComparation() {
    const comparation = ['', 'major', 'minor', 'equal'];
    return (
      <select
...
export default connect(mapStateToProps, mapDispatchToProps)(FilterByValues);
