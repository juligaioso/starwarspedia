...
class MainContainer extends React.Component {
  ...
  compare(planetValue, filterValue, operator) {
    let result = false;
    if (operator === "is bigger then") result = planetValue > filterValue;
    if (operator === "is less than") result = planetValue < filterValue;
    if (operator === "is equal to") result = planetValue === filterValue;
    this.bar = result;
    return result;
  }
